    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-slate-300 max-w-md">
          Buy and resell premium data bundles and exam result checkers with ease
        </p>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl">
        <div className="text-center">
          ...
          <h3 className="text-white font-semibold mb-2">Premium Data Bundles</h3>
          <p className="text-slate-400 text-sm">Access and resell curated data packages</p>
        </div>
        ...
        <div className="text-center">
          ...
          <h3 className="text-white font-semibold mb-2">Exam Result Checkers</h3>
          <p className="text-slate-400 text-sm">Check and verify exam results instantly</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 text-sm">Get your bundles immediately after purchase</p>
        </div>
      </div>
    </main>
  )
